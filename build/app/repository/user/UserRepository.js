...
var UserRepository = /** @class */ (function () {
    function UserRepository() {
        this.user = typeorm_1.getRepository(User_1.default);
    }
    ...
    UserRepository.prototype.findByEmail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.user.findOne({ where: { email: email } })];
                    case 1:
                        user = _a.sent();
    ...
    UserRepository.prototype.create = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.user.save(body)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, user];
                }
